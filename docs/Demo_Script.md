...
Shows the complete workflow on real documents and makes the AI's contribution visible.
Files: `dataset/indiacode/consumer_protection_act_2019.pdf` (real Act, 42 pages) and
`samples/employment_agreement.pdf`.

| Time | Show | Say |
|---|---|---|
| 0:00 | Sign-in page; click an example question in the live demo | "People sign papers they can't read. ClauseLens answers in plain words and always shows the page." |
| 0:20 | Continue with Google → account menu → *Privacy & activity* | "Private to your Google account, files encrypted, every access logged, delete everything in one click." |
| 0:35 | Upload the Consumer Protection Act; processing steps appear | "A real Act from India Code: reading pages, finding sections, understanding meaning, extracting facts." |
| 1:00 | Overview panel: document type **Act (high confidence)**, key facts | "It recognised this as an Act and why — from the Act number on page 1." |
